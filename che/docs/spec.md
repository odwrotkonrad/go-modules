...
CENTRALIZED_ASSETS_PROSE_HUMAN_REF: v0.0.3
CENTRALIZED_ASSETS_GENERIC_REF:
  value: v0.0.38
...
```yaml
renderTemplates:
  - source: "git::gitlab.com/konradodwrot/centralized/assets/prose/human@v0.0.3"
    options:
