...
#[why] needs the darwin warm build: play warm-go-darwin first, its artifacts are the only binaries these jobs run (no in-job go toolchain or self-build). optional so this manual job never blocks pipeline creation
