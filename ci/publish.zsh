...
print -n "$MODULE_VERSION" > dist/che_latest_version.txt
curl -fsSL --connect-timeout 30 --retry 10 --retry-delay 30 --header "JOB-TOKEN: ${CI_JOB_TOKEN}" --upload-file dist/che_latest_version.txt "${ALIAS}/che_latest_version.txt"
echo
##[<] 🤖🤖
