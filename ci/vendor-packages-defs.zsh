...
# $CHE_PACKAGES_REF (CI derives it from the group's GRP_KO_VAR_CHE_PACKAGES_REF,
# a host seeds it in .env), downloads that release's tarball from the che-packages generic package
