<!-- autogenerated using @gitlab.com/konradodwrot/prose//repos/go-modules/templates/3-audience/README.md.ontoRepo.tpl?ref=v0.0.34 -->
# go-modules
...
Four sibling repos duplicated toolchain, CI, conventions, release flow. One repo carries all of it. Cross-module changes land in one MR, and render-files folded into che, its only consumer.
